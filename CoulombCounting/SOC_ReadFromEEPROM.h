...
typedef struct {
  real_T TcompPersist;                 /* '<S1>/SOC_ReadFromEEPROM' */
  real32_T SoH2;                       /* '<S1>/SOC_ReadFromEEPROM' */
  real32_T SoH;                        /* '<S1>/SOC_ReadFromEEPROM' */
  real32_T cycleCount;                 /* '<S1>/SOC_ReadFromEEPROM' */
  int32_T CapacityRemains_mAh;         /* '<S1>/SOC_ReadFromEEPROM' */
  boolean_T PrevLatch;                 /* '<S1>/SOC_ReadFromEEPROM' */
  boolean_T SoHCalcEn;                 /* '<S1>/SOC_ReadFromEEPROM' */
} B_SOC_ReadFromEEPROM_SOCEstim_T;

extern void SOCEstimatio_SOC_ReadFromEEPROM(B_SOC_ReadFromEEPROM_SOCEstim_T
  *localB);
  
extern uint8_t memoryWriteOverride;
