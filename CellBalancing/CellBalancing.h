 ...
 *
 * hilite_system('v00_0A_0E/CellBalancing')    - opens subsystem v00_0A_0E/CellBalancing
 * hilite_system('v00_0A_0E/CellBalancing/Kp') - opens and selects block Kp
 *
 * Here is the system hierarchy for this model
 *
 * '<Root>' : 'v00_0A_0E'
 * '<S1>'   : 'v00_0A_0E/CellBalancing'
 * '<S2>'   : 'v00_0A_0E/CellBalancing/BalancingStateMachine'
 * '<S3>'   : 'v00_0A_0E/CellBalancing/InputProcessing'
 * '<S4>'   : 'v00_0A_0E/CellBalancing/InputProcessing/Chart'
 * '<S5>'   : 'v00_0A_0E/CellBalancing/InputProcessing/Chart1'
 * '<S6>'   : 'v00_0A_0E/CellBalancing/InputProcessing/Compare To Constant'
 */
